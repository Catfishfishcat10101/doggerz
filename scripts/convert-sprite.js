...
async function main() {
  if (!fs.existsSync(SRC)) {
    ...
    console.error('Place your uploaded sprite file at src/assets/sprite-source.png and re-run this script.');
    process.exitCode = 2;
    return;
  }
  ...
  try {
    ...
    console.log('Replace any placeholder sprite path in your app if necessary.');
  } catch (err) {
