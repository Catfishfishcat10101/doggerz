...
<<<<<<< HEAD:src/pages/Store.jsx
import { preloadJackRussellSheets } from "@/components/dog/assets/jrAtlasAssets.js";
=======
>>>>>>> 10f88903 (chore: remove committed backup folders):_backup/old-src-conflicts/pages/Store.jsx
...
function cosmeticDescription(item) {
  ...
  if (category === "toys") {
    ...
    if (id === "toy_squeaky_catfish")
      return "High-interest squeaky toy with a strong mood lift.";
  ...
  if (slot === "collar") {
    ...
    if (id === "collar_neon")
      return "A bright collar with a clean emerald finish.";
...
=======
    if (id === "tag_bolt") return "A fast-looking bolt tag for energetic pups.";
>>>>>>> 10f88903 (chore: remove committed backup folders):_backup/old-src-conflicts/pages/Store.jsx
