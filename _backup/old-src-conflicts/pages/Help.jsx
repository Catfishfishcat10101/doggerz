...
=======
                        2. Expect terrier energy
                      </div>
                      <p className="mt-2 text-sm text-zinc-300">
                        Jack Russells are alert, energetic dogs. Expect quick
                        mood shifts, sudden play bursts, and a puppy that needs
                        consistency before commands feel reliable.
>>>>>>> 10f88903 (chore: remove committed backup folders):_backup/old-src-conflicts/pages/Help.jsx
                      </p>
                    </div>
                    <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                      <div className="text-sm font-extrabold text-amber-200">
