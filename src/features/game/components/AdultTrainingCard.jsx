...
export default function AdultTrainingCard() {
  ...
  const ls = useSelector(selectDogLifeStage);
  const lifeStage =
    ls && typeof ls === "object" ? ls : { stage: "PUPPY", label: "Puppy" };
  ...
  const stageKey = String(lifeStage?.stage ?? "PUPPY").toUpperCase();
