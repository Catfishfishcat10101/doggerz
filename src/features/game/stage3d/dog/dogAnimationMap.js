...
const CLIP_CANDIDATES_BY_REQUEST = Object.freeze({
  ...
  Sit: ["cmd_sit", "Sitting_loop_1", "Sitting_loop_2", "Sitting_start"],
  ...
  Lay_Down: ["cmd_lay_down", "Lie_loop_1", "Lie_belly_loop_1", "Lie_start"],
  Lethargic_Lay: ["Lie_belly_loop_1", "Lie_loop_2", "Lie_Sleep_loop"],
  GateWatch: ["Idle_7", "Idle_6", "Idle_1"],
  Stay: ["cmd_stay", "Idle_1", "Sitting_loop_1"],
  Come: ["cmd_come", "Run_F_IP", "Trot_F_IP", "Walk_F_IP"],
  Heel: ["cmd_heel", "Walk_F_IP", "Trot_F_IP"],
  Paw: ["cmd_paw", "Sitting_loop_1", "Idle_2"],
  ...
  Spin: ["cmd_spin", "Turn_R_IP", "Trot_R_IP", "Walk_R_IP", "Trot_F_IP"],
