  ...
  return (
    <footer className="border-t border-zinc-800 bg-zinc-950 text-xs text-zinc-500 py-4">
      <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
        ...
        <nav className="flex items-center gap-4">
          <button onClick={() => navigate("/about")} className="hover:text-zinc-300">
            About
          </button>
          <button onClick={() => navigate("/settings")} className="hover:text-zinc-300">
            Settings
          </button>
          <button onClick={() => navigate("/legal")} className="hover:text-zinc-300">
            Legal
          </button>
        </nav>
      </div>
