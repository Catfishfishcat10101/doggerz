...
// Cleanliness tiers are derived from the `stats.cleanliness` 0–100 value.
...
// Effects applied each tick (see applyCleanlinessPenalties) and copy shown
// when a tier change is detected (see syncCleanlinessTier).
const CLEANLINESS_TIER_EFFECTS = {
  FRESH: {
    label: 'Fresh',
