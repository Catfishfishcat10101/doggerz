 ...
 */
export function getDogStaticSpriteUrl(stageLike) { // eslint-disable-line no-unused-vars
  return '/icons/doggerz-192.png';
}
 ...
 */
export function getDogPixiSheetUrl(stageLike, conditionLike) { // eslint-disable-line no-unused-vars
  return '/icons/doggerz-192.png';
}
