    ...
    <AppBackground zipCode="65401">
      <div className="min-h-screen flex flex-col">
        ...
        <header className="w-full border-b border-emerald-500/40 bg-black/60 backdrop-blur">
            ...
            <nav className="flex items-center gap-3">
              ...
              <div id="site-nav" className={`hidden sm:flex gap-3 text-sm`}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    (isActive
                      ? "text-emerald-200 underline"
                      : "text-emerald-100 hover:underline") +
                    " px-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300 focus-visible:ring-offset-2"
                  }
                >
                  Play
                </NavLink>
          ...
          >
            <div
              className={`px-4 py-3 flex flex-col gap-2 transform transition-transform duration-200 ${mobileOpen ? "translate-y-0" : "-translate-y-2"}`}
            >
              <NavLink
                to="/"
                onClick={() => setMobileOpen(false)}
                className={({ isActive }) =>
                  isActive ? "text-emerald-200" : "text-emerald-100"
                }
              >
                Play
              </NavLink>
