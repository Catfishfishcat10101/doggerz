  ...
  return (
    <section className="mx-auto max-w-3xl px-4 sm:px-6 py-10 leading-relaxed">
      ...
      <section className="text-sm text-gray-500 mt-10">
        ...
        <p className="opacity-80">
          For privacy questions, email us at: catfishfishcat10101@gmail.com.</p>
        <p> We retain user data as long as the account is active or as required by law.</p>
        <p> Doggerz is not intended for users under the age of 13. We do not knowingly collect data from children.</p>  
        <p>We use Firebase services for authentication and analytics. You can review </p>
      </section>
      </section>
      )};