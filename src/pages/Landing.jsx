        ...
        <div className="rounded-3xl border border-emerald-500/15 bg-black/35 backdrop-blur-md shadow-[0_0_60px_rgba(16,185,129,0.10)] overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 sm:p-10 lg:p-12">
              ...
              <h1 className="text-5xl sm:text-6xl font-extrabold tracking-tight text-emerald-200">
                Doggerz
              </h1>

              <p className="mt-4 text-base sm:text-lg text-zinc-200 max-w-xl">
                Adopt a pup, care for it daily, and earn real progression. Potty
                training comes first—tricks unlock when you’ve earned them.
              </p>
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
                  ...
                  <div className="text-xs text-zinc-300 mt-1">
                    Progress-driven, not spam-clicking.
                  </div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
                  <div className="text-sm font-bold text-emerald-200">
                  ...
                  <div className="text-xs text-zinc-300 mt-1">
                    Locked until potty training is complete.
                  </div>
                </div>
              </div>
            </div>
