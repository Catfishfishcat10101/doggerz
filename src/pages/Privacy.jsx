    ...
    <PageShell mainClassName="px-6 py-10" containerClassName="w-full max-w-3xl">
      <div className="space-y-8 text-sm text-zinc-300">
        ...
        <section className="space-y-2">
          ...
          <p>
            Doggerz is designed to work in <b>offline / local-only mode</b>. By
            default, your dog and settings live in your browser storage on this
            device.
          </p>
          <p>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              <b>No selling data</b>: this project is not built to sell personal
              data.
            </li>
            <li>
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            recognition capability. This may require microphone permission, and
            speech processing may be handled by your browser or device vendor.
          </p>
        ...
        <section className="space-y-2">
          ...
          <p>
            This policy may change as Doggerz evolves. Significant changes will
