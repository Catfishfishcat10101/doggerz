...
npm run build`}
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              <h2 className="text-lg font-bold">3D dog preview gallery</h2>
              <p className="mt-1 max-w-3xl text-sm text-zinc-400">
                Quick visual tuning bench for the current Jack Russell GLB
                preview wrapper.
              </p>
              <p className="mt-2 text-xs text-zinc-500">
                This page intentionally uses the GLB renderer only.
              </p>
            </div>

            <div className="flex flex-wrap gap-2 text-[11px] uppercase tracking-[0.18em] text-zinc-300">
              <Badge>GLB renderer</Badge>
              <Badge>shared model</Badge>
