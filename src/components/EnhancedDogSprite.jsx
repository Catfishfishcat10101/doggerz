...
export default function EnhancedDogSprite({
    spritePublicPath = "/sprites/jack_russell_puppy.webp",
    alt = "Dog sprite",
    className = ""
}) {
    ...
    useEffect(() => {
        ...
        const candidates = [
            // Prefer whatever the caller requested first
            spritePublicPath,

            // Canonical (public/) sprite locations
            "/sprites/jack_russell_puppy.webp",
            "/sprites/jack_russell_puppy.png",

            // Legacy fallbacks (kept for older deployments / differing asset layouts)
            "/assets/sprites/jack_russell_puppy.webp",
            "/assets/sprites/jack_russell_puppy.png",
            "/assets/images/jack_russell_puppy.webp",
            "/assets/images/jack_russell_puppy.png",
            "/images/jack_russell_puppy.webp",
