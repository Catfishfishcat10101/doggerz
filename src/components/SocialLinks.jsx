...
export default function SocialLinks({ className = "", size = 18, links = {} }) {
  const cfg = { ...SOCIAL, ...links };
  ...
  return (
    <div className={className}>
      <a
        ...
        target={cfg.twitter ? "_blank" : undefined}
        rel={cfg.twitter ? "noopener noreferrer" : undefined}
      >
        <svg
          width={size}
          height={size}
      ...
      <a
        ...
        aria-label="Discord"
        className="rounded-md p-1 text-zinc-300 hover:text-emerald-200"
        target={cfg.discord ? "_blank" : undefined}
        rel={cfg.discord ? "noopener noreferrer" : undefined}
      >
        <svg
          width={size}
          height={size}
      ...
      <a
        ...
        aria-label="GitHub"
        className="rounded-md p-1 text-zinc-300 hover:text-emerald-200"
        target={cfg.github ? "_blank" : undefined}
        rel={cfg.github ? "noopener noreferrer" : undefined}
      >
        <svg
          width={size}
          height={size}
