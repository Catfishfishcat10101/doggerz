...
// NOTE: Your project previously had FirebaseAutoSave at src/components/FirebaseAutoSave.jsx
...
export default function GameScreen() {
  ...
  useEffect(() => {
    ...
    if (nx !== pos.x || ny !== pos.y) {
      dispatch(
        setPosition({ x: nx, y: ny, world: { w: WORLD_W, h: WORLD_H, tile: TILE } })
      );
    }
  ...
  const happinessWidthStyle = { width: `${Math.max(0, Math.min(100, happiness))}%` };
