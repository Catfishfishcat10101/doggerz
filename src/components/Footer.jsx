      ...
      <div className="mx-auto grid w-full max-w-6xl gap-4 md:grid-cols-[1fr_auto] md:items-center">
        ...
        <div className="flex flex-col items-start gap-3 md:items-end">
          <nav className="grid grid-cols-2 gap-x-6 gap-y-1 text-sm text-zinc-300 sm:grid-cols-3">
            <Link to="/legal" className="hover:text-emerald-200">Legal</Link>
            <Link to="/privacy" className="hover:text-emerald-200">Privacy</Link>
            <Link to="/faq" className="hover:text-emerald-200">FAQs</Link>
            <Link to="/developers" className="hover:text-emerald-200">Developers</Link>
            <Link to="/help" className="hover:text-emerald-200">Help</Link>
            <Link to="/settings" className="hover:text-emerald-200">Settings</Link>
          </nav>
