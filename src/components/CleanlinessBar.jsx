...
const CleanlinessBar = () => {
  ...
  return (
    <div className="w-full max-w-sm px-4 py-2 bg-white/10 backdrop-blur-md rounded-lg shadow-md mt-2 text-white">
      <h3 className="text-sm font-semibold mb-2">🧼 Cleanliness Status</h3>
